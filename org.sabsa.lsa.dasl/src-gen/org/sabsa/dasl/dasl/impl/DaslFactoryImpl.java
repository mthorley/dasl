...
public class DaslFactoryImpl extends EFactoryImpl implements DaslFactory
{
  ...
  public EObject create(EClass eClass)
  {
    switch (eClass.getClassifierID())
    {
      ...
      case DaslPackage.BASE_CONTROL: return createBaseControl();
   ...
   */
  @Override
  public BaseControl createBaseControl()
  {
    BaseControlImpl baseControl = new BaseControlImpl();
    return baseControl;
  }
   ...
   * @generated
   */
  public NIST80053ARev4_FamilyType createNIST80053ARev4_FamilyTypeFromString(EDataType eDataType, String initialValue)
  {
    NIST80053ARev4_FamilyType result = NIST80053ARev4_FamilyType.get(initialValue);
    if (result == null) throw new IllegalArgumentException("The value '" + initialValue + "' is not a valid enumerator of '" + eDataType.getName() + "'");
    return result;
  }
   ...
   * @generated
   */
  public String convertNIST80053ARev4_FamilyTypeToString(EDataType eDataType, Object instanceValue)
  {
    return instanceValue == null ? null : instanceValue.toString();
  }
