 ...
 * </p>
 * <ul>
 *   <li>{@link org.sabsa.dasl.dasl.impl.ComponentImpl#getName <em>Name</em>}</li>
...
public class ComponentImpl extends AbstractElementImpl implements Component
{
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DaslPackage.COMPONENT__NAME, oldName, name));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case DaslPackage.COMPONENT__NAME:
        return getName();
