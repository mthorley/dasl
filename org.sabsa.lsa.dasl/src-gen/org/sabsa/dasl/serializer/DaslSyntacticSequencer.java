...
public class DaslSyntacticSequencer extends AbstractSyntacticSequencer {
	...
	protected AbstractElementAlias match_Flow_AssetsKeyword_8_0_q;
	protected AbstractElementAlias match_Flow_ControlsKeyword_9_0_q;
	...
	protected void init(IGrammarAccess access) {
		...
		match_Flow_AssetsKeyword_8_0_q = new TokenAlias(false, true, grammarAccess.getFlowAccess().getAssetsKeyword_8_0());
		match_Flow_ControlsKeyword_9_0_q = new TokenAlias(false, true, grammarAccess.getFlowAccess().getControlsKeyword_9_0());
	...
	protected void emitUnassignedTokens(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		...
		for (AbstractElementAlias syntax : transition.getAmbiguousSyntaxes()) {
			...
			else if (match_Flow_AssetsKeyword_8_0_q.equals(syntax))
				emit_Flow_AssetsKeyword_8_0_q(semanticObject, getLastNavigableState(), syntaxNodes);
			else if (match_Flow_ControlsKeyword_9_0_q.equals(syntax))
				emit_Flow_ControlsKeyword_9_0_q(semanticObject, getLastNavigableState(), syntaxNodes);
	 ...
	 */
	protected void emit_Flow_AssetsKeyword_8_0_q(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
		acceptNodes(transition, nodes);
	}
	 ...
	 */
	protected void emit_Flow_ControlsKeyword_9_0_q(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
		acceptNodes(transition, nodes);
	}
