		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getComponentAccess().getAssetsAssignment_13(), "rule__Component__AssetsAssignment_13");
					...
					put(grammarAccess.getFlowAccess().getAssetsAssignment_8(), "rule__Flow__AssetsAssignment_8");
					put(grammarAccess.getFlowAccess().getControlsAssignment_10(), "rule__Flow__ControlsAssignment_10");
